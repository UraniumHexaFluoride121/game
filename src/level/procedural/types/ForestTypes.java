...
public abstract class ForestTypes {
    ...
    public static final GeneratorType FOREST_ISLAND_DEFAULT = PresetTypes.defaultIsland("forest_island_default", 3, 6, new FunctionalWeightedRandom<Integer, GenUtil.StackRandomData>()
    ...
    public static final GeneratorType FOREST_ISLAND_VERTICAL = PresetTypes.verticalIsland("forest_island_vertical", 2, 4, 6, new FunctionalWeightedRandom<Integer, GenUtil.StackRandomData>()
            .add(1, s -> 8f)
            .add(2, s -> 15f)
            .add(3, s -> 10f)
            .add(4, s -> s.lastSize() > 8 ? 2f : 0)
    ).get();
    public static final GeneratorType FOREST_ISLAND_VERTICAL_LARGE = PresetTypes.verticalIsland("forest_island_vertical_large", 1, 2, 8, 15, new FunctionalWeightedRandom<Integer, GenUtil.StackRandomData>()
            .add(2, s -> 5f)
            .add(3, s -> 10f)
            .add(4, s -> 15f)
            .add(5, s -> 12f)
